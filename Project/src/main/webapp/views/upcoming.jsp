...
<% 
if (request.getAttribute("upcomingMusicals") == null) {
    String contextPath = request.getContextPath();
    response.sendRedirect(contextPath + "/upcoming");
	...
	<div class="container">
        ...
        <ul class="nav nav-tabs" id="tabMenu" role="tablist">
            <li class="nav-item" role="presentation">
                <a class="nav-link" id="ongoing-tab" href="views/ongoing.jsp">현재 공연</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link active" id="upcoming-tab" href="views/upcoming.jsp">예정 공연</a>
            </li>
        </ul>

		<br>
		<div class="row row-cols-1 row-cols-md-3 g-4">
			<c:forEach var="musical" items="${upcomingMusicals}">
