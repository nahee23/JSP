...
<body>
	...
	<main class="container">
		...
		<form name="writeFrm" method="POST"
			action="${pageContext.request.contextPath}/ListController"
			onsubmit="return validateForm(this);">
			<input type="hidden" name="idx" value="${ board.idx }" /> <input
				type="hidden" name="prevOfile" value="${ board.ofile }" /> <input
				type="hidden" name="prevSfile" value="${ board.sfile }" /> <br>
			<table class="table-border" width="100%">
				...
				<tr>
					...
					<td><textarea name="content"
							style="width: 90%; height: 100px;">${ board.content }</textarea>
					</td>
				</tr>
				<tr>
					<td>첨부 파일</td>
					<td><input type="file" name="ofile" class="mt-3" /> </td>
				</tr>
				<tr>
					<td>비밀번호</td>
